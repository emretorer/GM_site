...
import PanelSidebar, { navItems } from '../components/PanelSidebar.jsx'
import { ParentChildProvider } from '../context/ParentChildContext.jsx'
...
function PanelLayout() {
  ...
  const isAuthScreen =
    location.pathname.startsWith('/panel/login') ||
    location.pathname.startsWith('/panel/kayit')
  const showSidebar = !location.pathname.startsWith('/panel/haberler') && !isAuthScreen
  ...
  return (
    <div className="panel-root">
      {showSidebar ? (
        <PanelSidebar isExpanded={isExpanded} onToggle={() => setIsExpanded(prev => !prev)} />
      ) : null}
      {showSidebar ? (
        <button
          type="button"
